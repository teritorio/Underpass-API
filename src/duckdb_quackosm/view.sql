...
SELECT id, version, created, changeset, uid, tags, nodes, members, geom, osm_type FROM node_by_geom
UNION ALL
SELECT id, version, created, changeset, uid, tags, nodes, members, geom, osm_type FROM way_by_geom
UNION ALL
SELECT id, version, created, changeset, uid, tags, nodes, members, geom, osm_type FROM relation_by_geom
;

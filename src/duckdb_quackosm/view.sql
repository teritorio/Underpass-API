...
SELECT id, NULL::int AS version, NULL::timestamp AS created, NULL::int AS changeset, NULL::int AS uid, tags, NULL::bigint[] AS nodes, NULL::json AS members, geom, geom_bbox, 'n' AS osm_type FROM read_parquet('#{parquet}_nodes_by_geom');
...
SELECT id, NULL::int AS version, NULL::timestamp AS created, NULL::int AS changeset, NULL::int AS uid, tags, NULL::bigint[] AS nodes, NULL::json AS members, geom, geom_bbox, 'w' AS osm_type FROM read_parquet('#{parquet}_ways_by_geom');
...
SELECT id, NULL::int AS version, NULL::timestamp AS created, NULL::int AS changeset, NULL::int AS uid, tags, NULL::bigint[] AS nodes, NULL::json AS members, geom, geom_bbox, 'r' AS osm_type FROM read_parquet('#{parquet}_relations_by_geom');
...
SELECT id, NULL::int AS version, NULL::timestamp AS created, NULL::int AS changeset, NULL::int AS uid, tags, NULL::bigint[] AS nodes, NULL::json AS members, geom, geom_bbox, 'w' AS osm_type FROM read_parquet('#{parquet}_ways_by_geom') wHERE list_contains(['POLYGON', 'MULTIPOLYGON'], ST_GeometryType(geom))
UNION ALL
SELECT id + 3600000000 AS id, NULL::int AS version, NULL::timestamp AS created, NULL::int AS changeset, NULL::int AS uid, tags, NULL::bigint[] AS nodes, NULL::json AS members, geom, geom_bbox, 'a' AS osm_type FROM read_parquet('#{parquet}_relations_by_geom') wHERE list_contains(['POLYGON', 'MULTIPOLYGON'], ST_GeometryType(geom))
;

...
CREATE OR REPLACE TEMP VIEW node_by_id AS SELECT * FROM node;
...
CREATE OR REPLACE TEMP VIEW way_by_id AS SELECT * FROM way;
...
CREATE OR REPLACE TEMP VIEW relation_by_id AS SELECT * FROM relation;
